...
{ name:"Arial Unicode MS",	system:new Set([mac, win]), locales:new Set(['latn', 'latn-ha', 'latn-bm', 'latn-ff', 'latn-afr', 'ipa', 'germ', 'arab', 'arab-arb', 'arab-ug', 'beng', 'deva', 'gujr', 'guru', 'knda', 'mlym', 'taml', 'thai', 'armn', 'cyrl', 'geor', 'grek', 'hebr', 'arab-fa', 'hans', 'hant', 'jpan', 'kore']), style:'mod/mono' },
...
{ name:"Arial",				system:new Set([win, mac, ios]), locales:new Set(['latn', 'latn-ha', 'latn-bm', 'latn-ff', 'latn-afr', 'ipa', 'germ', 'arab', 'arab-arb', 'arab-fa', 'arab-ug', 'arab-ha', 'armn', 'cyrl', 'grek', 'hebr']), style:'sans' },
...
{ name:"Calibri",			system:new Set([win]), locales:new Set(['latn', 'latn-ha', 'latn-bm', 'latn-ff', 'latn-afr', 'ipa', 'arab', 'armn', 'cyrl', 'geor', 'grek', 'hebr']), style:'sans' },
...
{ name:"Ebrima",			system:new Set([win]), locales:new Set(['ethi','adlm','nkoo', 'osma', 'tfng', 'tfng-zgh', 'tfng-ber', 'vaii']), style:'sans' },
...
{ name:"Geneva",			system:new Set([mac]), locales:new Set(['latn', 'latn-ha', 'latn-bm', 'latn-ff', 'latn-afr', 'ipa', 'cyrl', 'grek', 'germ', 'cher', 'ogam', 'lyci']), style:'sans' },
...
"Payap Lanna": { notes: "[GRAPHITE] No OpenType support available at the moment for lack of the necessary shaping." },
