...
{ name:"Calibri",			system:new Set([win]), locales:new Set(['latn', 'latn-ha', 'latn-afr', 'ipa']), style:'sans' },
...
{ name:"Harmattan",			system:new Set([sil]), locales:new Set(['arab', 'arab-ajami', 'arab-ha']), style:'sans' },
...
{ name:"Leelawadee",		system:new Set([win]), locales:new Set(['thai', 'bugi']), style:'sans' },
...
{ name:"Nirmala UI",		system:new Set([win]), locales:new Set(['beng', 'gujr', 'guru', 'mlym', 'sinh', 'telu']), style:'sans' },
{ name:"Nokyung",			system:new Set([goog]), locales:new Set(['talu']), style:'sans' },
{ name:"Noto Naskh Arabic",	system:new Set([goog]), locales:new Set(['arab', 'arab-arb', 'arab-ajami', 'arab-fa', 'arab-ha', 'arab-ug']), style:'sans' },
...
{ name:"Noto Sans Arabic",	system:new Set([goog]), locales:new Set(['arab', 'arab-arb', 'arab-ajami', 'arab-fa', 'arab-ha', 'arab-sans']), style:'sans' },
