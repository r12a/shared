...
{ name:"MingLiu",			system:new Set([win, mac]), locales:new Set(['hani', 'hant']), style:'song/ming', wd:true },
...
/* Mincho */
{ name:"MS Mincho",			system:new Set([win, mac]), locales:new Set(['jpan']), style:'mincho', wd:true },
...
{ name:"Cambay Devanagari",	system:new Set([mac]), locales:new Set(['deva', 'new']), style:'serif', md:true },
...
{ name:"Estrangelo Edessa",	system:new Set([win]), locales:new Set(['syrc']), style:'serif', wd:true },
...
{ name:"Annai MN",			system:new Set([mac]), locales:new Set(['deva', 'taml']), style:'sans', md:true },
...
{ name:"Cordia UPC",		system:new Set([win]), locales:new Set(['thai']), style:'sans', wd:true },
...
{ name:"Geneva",			system:new Set([mac]), locales:new Set(['latn', 'latn-ha', 'latn-afr', 'ipa', 'cyrl', 'grek', 'germ', 'cher', 'ogam', 'lyci']), style:'sans' },
...
{ name:"Noto Sans Syriac",	system:new Set([goog]), locales:new Set(['syrc']), style:'sans' },
...
{ name:"Tiro Bangla",		system:new Set([mac]), locales:new Set(['beng', 'new']), style:'sans', md:true },
...
{ name:"Modak",				system:new Set([mac]), locales:new Set(['deva', 'new']), style:'heavy', md:true },
...
{ name:"October Compressed Devanagari",system:new Set([mac]), locales:new Set(['deva']), style:'other', md:true },
{ name:"October Compressed Tamil",system:new Set([mac]), locales:new Set(['taml']), style:'other', md:true },
