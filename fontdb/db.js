...
{ name:"Al Bayan",			system:new Set([yes, mac]), locales:new Set(['arab', 'arab-arb', 'arab-fa']) },
{ name:"Al Nile",			system:new Set([yes, mac]), locales:new Set(['arab', 'arab-arb']) },
{ name:"Al Tarikh",			system:new Set([yes, mac]), locales:new Set(['arab', 'arab-arb']) },
{ name:"Aldhabi",			system:new Set([yes, win]), locales:new Set(['arab', 'arab-arb', 'arab-fa', 'arab-ur']) },
...
{ name:"Andalus",			system:new Set([yes, win]), locales:new Set(['arab', 'arab-arb', 'arab-arb', 'arab-fa']) },
...
{ name:"Arabic Typesetting",system:new Set([yes, win]), locales:new Set(['arab', 'arab-arb', 'arab-ajami', 'arab-fa', 'arab-ug', 'arab-ur']) },
{ name:"Arial",				system:new Set([yes, win]), locales:new Set(['latn', 'latn-ha', 'latn-afr', 'ipa', 'germ', 'arab', 'arab-arb', 'grek', 'hebr', 'arab-fa', 'arab-ug']) },
{ name:"Arial Hebrew",		system:new Set([mac]), locales:new Set(['hebr']) },
{ name:"Arial Unicode MS",	system:new Set([yes, mac, win]), locales:new Set(['latn', 'latn-ha', 'latn-afr', 'ipa', 'germ', 'arab', 'arab-arb', 'thai', 'khmr', 'armn', 'cyrl', 'geor', 'grek', 'syrc', 'hebr', 'arab-fa', 'arab-ug']) },
...
{ name:"Baghdad",			system:new Set([yes, mac]), locales:new Set(['arab', 'arab-arb', 'arab-fa']) },
...
{ name:"Beirut",			system:new Set([yes, mac]), locales:new Set(['arab', 'arab-arb']) },
...
{ name:"Courier New",		system:new Set([yes, win]), locales:new Set(['latn', 'latn-ha', 'latn-afr', 'ipa', 'arab', 'arab-arb', 'arab-fa', 'hebr']) },
...
{ name:"Damascus",			system:new Set([yes, mac]), locales:new Set(['arab', 'arab-arb', 'arab-ajami', 'arab-fa']) },
{ name:"DaunPenh",			system:new Set([win]), locales:new Set(['khmr']) },
{ name:"David",				system:new Set([win]), locales:new Set(['hebr']) },
{ name:"Decotype Naskh",	system:new Set([yes, mac]), locales:new Set(['arab', 'arab-arb', 'arab-fa']) },
...
{ name:"Diwan Kufi",		system:new Set([yes, mac]), locales:new Set(['arab', 'arab-arb']) },
{ name:"Diwan Thuluth",		system:new Set([yes, mac]), locales:new Set(['arab', 'arab-arb']) },
...
{ name:"Farah",				system:new Set([yes, mac]), locales:new Set(['arab', 'arab-arb']) },
...
{ name:"Geeza Pro",			system:new Set([yes, mac]), locales:new Set(['arab', 'arab-arb', 'arab-ajami', 'arab-fa', 'arab-ug']) },
...
{ name:"KufiStandardGK",	system:new Set([yes, mac]), locales:new Set(['arab', 'arab-arb', 'arab-fa']) },
...
{ name:"Mishafi",			system:new Set([yes, mac]), locales:new Set(['arab', 'arab-arb']) },
{ name:"Mishafi Gold",		system:new Set([yes, mac]), locales:new Set(['arab', 'arab-arb']) },
...
{ name:"Muna",				system:new Set([yes, mac]), locales:new Set(['arab', 'arab-arb']) },
...
{ name:"Myriad Arabic",		system:new Set([yes, mac]), locales:new Set(['arab', 'arab-arb', 'arab-fa']) },
{ name:"Nadeem",			system:new Set([yes, mac]), locales:new Set(['arab', 'arab-arb', 'arab-fa']) },
...
{ name:"Noto Kufi Arabic",	system:new Set([yes, goog]), locales:new Set(['arab', 'arab-arb']) },
{ name:"Noto Naskh Arabic",	system:new Set([yes, goog]), locales:new Set(['arab', 'arab-arb', 'arab-ajami', 'arab-fa', 'arab-ug']) },
...
{ name:"Noto Sans Arabic",	system:new Set([goog]), locales:new Set(['arab', 'arab-arb', 'arab-ajami', 'arab-fa']) },
{ name:"Noto Sans Arabic Light",system:new Set([goog]), locales:new Set(['arab', 'arab-arb', 'arab-ajami', 'arab-fa']) },
...
{ name:"Sakkal Majalla",	system:new Set([yes, win]), locales:new Set(['arab', 'arab-arb', 'arab-ajami', 'arab-fa']) },
{ name:"Sana",				system:new Set([yes, mac]), locales:new Set(['arab', 'arab-arb']) },
{ name:"Sanskrit Text",		system:new Set([win]), locales:new Set(['deva']) },
{ name:"Sathu",				system:new Set([yes, mac]), locales:new Set(['thai']) },
{ name:"Scheherazade",		system:new Set([yes, sil]), locales:new Set(['arab', 'arab-arb', 'arab-ajami', 'arab-fa', 'arab-ug', 'arab-ur']) },
{ name:"Segoe UI",			system:new Set([yes, win]), locales:new Set(['arab', 'arab-arb', 'cyrl', 'geor', 'grek','hebr', 'arab-fa', 'lisu']) },
...
{ name:"Simplified Arabic",	system:new Set([yes, win]), locales:new Set(['arab', 'arab-arb', 'arab-ajami', 'arab-fa', 'arab-ug']) },
{ name:"Simplified Arabic Fixed",system:new Set([yes, win]), locales:new Set(['arab', 'arab-arb']) },
...
{ name:"Tahoma",			system:new Set([yes, mac, win]), locales:new Set(['arab', 'arab-arb','thai', 'grek', 'hebr', 'arab-fa', 'arab-ug']) },
...
{ name:"Traditional Arabic",system:new Set([yes, win]), locales:new Set(['arab', 'arab-arb', 'arab-fa', 'arab-ug']) },
...
{ name:"Waseem",			system:new Set([yes, mac]), locales:new Set(['arab', 'arab-arb']) },
