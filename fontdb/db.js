...
{ name:"Cambria",			system:new Set([win]), locales:new Set(['latn', 'latn-ha', 'latn-bm', 'latn-afr', 'ipa']), style:'serif' },
{ name:"Charis SIL",		system:new Set([sil]), locales:new Set(['latn', 'latn-ha', 'latn-bm', 'latn-afr', 'ipa', 'germ']), style:'serif' },
...
{ name:"Doulos SIL",		system:new Set([sil]), locales:new Set(['latn', 'latn-ha', 'latn-bm', 'latn-afr', 'ipa', 'cyrl', 'germ']), style:'serif' },
...
{ name:"Gentium Plus",		system:new Set([sil]), locales:new Set(['latn', 'latn-ha', 'latn-bm', 'latn-afr', 'ipa', 'cyrl', 'grek', 'germ']), style:'serif' },
...
{ name:"Noto Serif",		system:new Set([goog]), locales:new Set(['latn', 'latn-ha', 'latn-bm', 'latn-afr', 'ipa', 'cyrl', 'grek']), style:'serif' },
...
{ name:"Arial Unicode MS",	system:new Set([mac, win]), locales:new Set(['latn', 'latn-ha', 'latn-bm', 'latn-afr', 'ipa', 'germ', 'arab', 'arab-arb', 'arab-ug', 'beng', 'deva', 'gujr', 'guru', 'knda', 'mlym', 'taml', 'thai', 'armn', 'cyrl', 'geor', 'grek', 'hebr', 'arab-fa', 'hans', 'hant', 'jpan', 'kore']), style:'mod/mono' },
...
{ name:"Arial",				system:new Set([win, mac, ios]), locales:new Set(['latn', 'latn-ha', 'latn-bm', 'latn-afr', 'ipa', 'germ', 'arab', 'arab-arb', 'arab-fa', 'arab-ug', 'arab-ha', 'armn', 'cyrl', 'grek', 'hebr']), style:'sans' },
...
{ name:"Calibri",			system:new Set([win]), locales:new Set(['latn', 'latn-ha', 'latn-bm', 'latn-afr', 'ipa', 'arab', 'armn', 'cyrl', 'geor', 'grek', 'hebr']), style:'sans' },
{ name:"Conakry",			system:new Set([other]), locales:new Set(['nkoo']), style:'sans' },
{ name:"Consolas",			system:new Set([win]), locales:new Set(['latn', 'latn-ha', 'latn-bm', 'ipa', 'latn-afr']), style:'sans' },
...
{ name:"Geneva",			system:new Set([mac]), locales:new Set(['latn', 'latn-ha', 'latn-bm', 'latn-afr', 'ipa', 'cyrl', 'grek', 'germ', 'cher', 'ogam', 'lyci']), style:'sans' },
...
{ name:"Lucida Grande",		system:new Set([mac]), locales:new Set(['latn','latn-ha', 'latn-bm', 'latn-afr', 'ipa', 'germ', 'hebr']), style:'sans' },
...
{ name:"Noto Sans",			system:new Set([goog]), locales:new Set(['latn', 'latn-ha', 'latn-bm', 'latn-afr', 'ipa', 'cyrl', 'grek']), style:'sans' },
...
{ name:"Segoe UI Historic",	system:new Set([win]), locales:new Set(['runr', 'shaw', 'syrc', 'armi', 'phli', 'prti', 'phnx', 'ugar', 'cprt', 'glag', 'goth', 'copt', 'ogam', 'ital', 'egyp', 'cari', 'xsux', 'lyci', 'lydi', 'xpeo', 'sarb', 'orkh', 'brah', 'khar']), style:'sans' },
...
{ name:"Courier New",		system:new Set([win, ios]), locales:new Set(['latn', 'latn-ha', 'latn-bm', 'latn-bm', 'latn-afr', 'ipa', 'arab', 'arab-arb', 'arab-fa', 'arab-ha', 'arab-other', 'hebr']), style:'monospaced' },
