...
{ name:"Apple LiSung",		system:new Set([mac]), locales:new Set(['hani', 'hant']) },
...
{ name:"Al Nile",			system:new Set([mac, ios]), locales:new Set(['arab', 'arab-arb']) },
...
{ name:"Arial",				system:new Set([win, mac, ios]), locales:new Set(['latn', 'latn-ha', 'latn-afr', 'ipa', 'germ', 'arab', 'arab-arb', 'arab-ha', 'grek', 'hebr', 'arab-fa', 'arab-ug']) },
...
{ name:"Baloo",				system:new Set([mac]), locales:new Set(['deva', 'new']) },
{ name:"Baloo Bhai",		system:new Set([mac]), locales:new Set(['gujr', 'new']) },
{ name:"Baloo Bhaijaan",	system:new Set([mac]), locales:new Set(['arab', 'new']) },
{ name:"Baloo Bhaina",		system:new Set([mac]), locales:new Set(['orya', 'new']) },
{ name:"Baloo Chettan",		system:new Set([mac]), locales:new Set(['mlym', 'new']) },
{ name:"Baloo Da",			system:new Set([mac]), locales:new Set(['beng', 'new']) },
{ name:"Baloo Paaji",		system:new Set([mac]), locales:new Set(['guru', 'new']) },
{ name:"Baloo Tamma",		system:new Set([mac]), locales:new Set(['knda', 'new']) },
{ name:"Baloo Tammudu",		system:new Set([mac]), locales:new Set(['telu', 'new']) },
{ name:"Baloo Thambi",		system:new Set([mac]), locales:new Set(['taml', 'new']) },
...
{ name:"Courier New",		system:new Set([win, ios]), locales:new Set(['latn', 'latn-ha', 'latn-afr', 'ipa', 'arab', 'arab-arb', 'arab-fa', 'arab-ha', 'hebr']) },
...
{ name:"Damascus",			system:new Set([mac, ios]), locales:new Set(['arab', 'arab-arb', 'arab-ajami', 'arab-fa']) },
...
{ name:"Farah",				system:new Set([mac, ios]), locales:new Set(['arab', 'arab-arb']) },
{ name:"Farisi",			system:new Set([mac]), locales:new Set(['arab', 'arab-arb', 'arab-fa']) },
...
{ name:"Geeza Pro",			system:new Set([mac, ios]), locales:new Set(['arab', 'arab-arb', 'arab-ajami', 'arab-fa', 'arab-ug']) },
...
{ name:"Mishafi",			system:new Set([mac, ios]), locales:new Set(['arab', 'arab-arb']) },
...
{ name:"Noto Nastaliq Urdu",system:new Set([goog, mac, ios]), locales:new Set(['arab', 'arab-ur']) },
...
{ name:"Trebuchet MS",		system:new Set([win, mac, ios]), locales:new Set(['armn', 'cyrl', 'grek']) },
...
{ name:"Verdana",			system:new Set([win, mac, ios]), locales:new Set(['latn', 'armn', 'cyrl', 'grek']) },
