 var fontSelection = '<option value="0">Select...</option>\
        ...
        <option value="Aleem Urdu Unicode">Aleem Urdu Unicode</option>\
        <option value="Arabic Typesetting">Arabic Typesetting</option>\
        <option value="Arial">Arial</option>\
        <option value="GlobalScience">GlobalScience</option>\
        <option value="Gohar Urdu Unicode">Gohar Urdu Unicode</option>\
        ...
        <option value="Urdu Naskh Asiatype">Urdu Naskh Asiatype</option>\
