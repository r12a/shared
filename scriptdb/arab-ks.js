...
ـ	_			_	_		Lm	i	baseline extender						U+0640: ARABIC TATWEEL	✓
...
ٓ	[			˜			Mn	o	vowel diacritic	used in decomposed text with آ					U+0653: ARABIC MADDAH ABOVE	✓
\u200B	]			␣			Cf		zero-width space						U+200B: ZERO WIDTH SPACE	
ع	}	ʔ ∅		ʔ	ʿ		Lo		plosive			ع ععع	عٲن	əːn	U+0639: ARABIC LETTER AIN	✓
ْ	*			͞			Mn		vowel killer						U+0652: ARABIC SUKUN	✓
ّ	&			˖			Mn	i	gemination marker						U+0651: ARABIC SHADDA	✓
₹	#			¤			Sc	i	currency symbol						U+20B9: INDIAN RUPEE SIGN	
...
غ	G	ɡ		ġ	g͟h		Lo		plosive			غ غغغ	غٲن	gəːn	U+063A: ARABIC LETTER GHAIN	✓
...
ح	H	h		ħ	ḥ		Lo		fricative			ح ححح	حے	baṛī heː	U+062D: ARABIC LETTER HAH	✓
...
ق	K	k		ḱ	q		Lo		plosive			ق ققق	قاف	kaːf	U+0642: ARABIC LETTER QAF	✓
خ	K	kʰ x		x	k͟h		Lo		aspirated plosive			خ خخخ	خے	kʰeː	U+062E: ARABIC LETTER KHAH	✓
...
ڑ	R	ɽ		ɽ	ṛ		Lo		approximant			ڑ ـڑ	ڑے	ɽeː	U+0691: ARABIC LETTER RREH	✓
ش	s	ʃ		ʃ	ś		Lo		fricative			ش ششش	شیٖن	ʃiːn	U+0634: ARABIC LETTER SHEEN	✓
ث	S	s		ṡ	s̱		Lo		fricative			ث ثثث	ثے	seː	U+062B: ARABIC LETTER THEH	✓
ص	S	s		ś	ṣ		Lo		fricative			ص صصص	صۄاد	sɔːd	U+0635: ARABIC LETTER SAD	✓
...
ط	T	t		ṫ	ṯ		Lo		plosive			ط ططط	طۄے	tɔj	U+0637: ARABIC LETTER TAH	✓
...
ذ	Z	z		z	ẕ		Lo		fricative			ذ ـذ	ذال	zaːl	U+0630: ARABIC LETTER THAL	✓
ض	Z	z		ź	z̤		Lo		fricative			ض ضضض	ضۄاد	zɔːd	U+0636: ARABIC LETTER DAD	✓
ظ	Z	z		ẑ	ẓ		Lo		fricative			ظ ظظظ	ظۄے	zɔj	U+0638: ARABIC LETTER ZAH	✓
...
ٖ				ˌ			Mn	o	vowel diacritic	orphan, used with یٖـ					U+0656: ARABIC SUBSCRIPT ALEF	✓
...
ࢡ				b͇			Lo	d	Fulfulde character	do not use !	بٔ				U+08A1: ARABIC LETTER BEH WITH HAMZA ABOVE	✓
ݬ				r͇			Lo	d	Ormuri character	do not use !	رٔ				U+076C: ARABIC LETTER REH WITH HAMZA ABOVE	✓
ځ				ħ͇			Lo	d	Pashto character	do not use !	حٔ				U+0681: ARABIC LETTER HAH WITH HAMZA ABOVE	✓
ۆ				o͇			Lo	d	vowel for Uighur, Kurdish, Kazakh, Azerbaijani, Bosnian	do not use !	وٚ				U+06C6: ARABIC LETTER OE	✓
ێ				e͇			Lo	d	vowel for Kurdish	do not use !	یٚ				U+06CE: ARABIC LETTER YEH WITH SMALL V	✓
																
ٛ				–			Mn	d	inverted v	do not use !					U+065B: ARABIC VOWEL SIGN INVERTED SMALL V ABOVE	
