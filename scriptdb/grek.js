var spreadsheet = `grek-el	key	ipa	ipa+	ipaOther	translit	transc	kbd	class	status	type	usage	lc	uc	native name	latin name	ucs name	block
π	p	p			p		p	Ll		consonant			Π	πι	pi	U+03C0: GREEK SMALL LETTER PI	✓
Π	P	P			P		P	Lu		consonant		π		πι	pi	U+03A0: GREEK CAPITAL LETTER PI	✓
ψ	p	p͡s		b͡z	p͡s		c	Ll		consonant			Ψ	ψι	psi	U+03C8: GREEK SMALL LETTER PSI	✓
Ψ	P	P͡S			P͡S		C	Lu		consonant		ψ		ψι	psi	U+03A8: GREEK CAPITAL LETTER PSI	✓
μπ		b		mb	mp					digraph	when word-initial.					U+03BC U+03C0: GREEK SMALL LETTER MU, SMALL LETTER PI	
...
ξ	k	ks		ɡ͡z	k͡s		j	Ll		consonant			Ξ	ξι	xi	U+03BE: GREEK SMALL LETTER XI	✓
...
γ	y	ɣ ʝ		ɲ ŋ	ɣ		g	Ll		consonant			Γ	γάμμα	gamma	U+03B3: GREEK SMALL LETTER GAMMA	✓
